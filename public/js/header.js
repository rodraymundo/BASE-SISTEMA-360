export function renderHeader(user) {
  ...
  header.innerHTML = `
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarNav">
        ...
        ${user.id_puesto === 35 ? `
            <li><a class="nav-link" href="/Gestion-Personal-Resultados">Personal</a></li>
            <li><a class="nav-link" href="/Gestion-Permisos">Permisos</a></li>
            <li><a class="nav-link" href="/Historico-Evaluaciones">Histórico</a></li>
          ` : `
  ...
  `;
  // Agregar el modal de cambio de contraseña al final del body
